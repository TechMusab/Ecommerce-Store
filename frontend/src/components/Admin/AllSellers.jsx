        ...
        <div className="w-full fixed top-0 left-0 z-[999] bg-[#00000039] flex items-center justify-center h-screen">
          <div className="w-[95%] 800px:w-[40%] min-h-[20vh] bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="w-full flex items-center justify-center gap-6">
              <div
                className={`${styles.button} text-white text-[18px] !h-[42px] mr-4 rounded-md shadow-md transition-all hover:bg-opacity-80`}
                onClick={() => setOpen(false)}
              >
                Cancel
              </div>
              <div
                className={`${styles.button} text-white text-[18px] !h-[42px] ml-4 rounded-md shadow-md transition-all hover:bg-opacity-80`}
